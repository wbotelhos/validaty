...
;(function($) {
  ...
  methods._display = function(result) {
    ...
    methods._writeMessage.call(this, message, result);
    methods._showMessage.call(this, message);
  };
  ...
  methods._message = function(result) {
    ...
    var html    = '<ul></ul>';
    var message = $('<div />', { html: html, id: result.el[0].hash, 'class': 'validaty-message' });
