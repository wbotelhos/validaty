...
;(function($) {
  ...
  methods._bind = function() {
    ...
    that.distinct = methods._distinct.call(that);

    $(this).on('submit.validaty', function(evt) {
      methods._process.call(that, that.distinct, evt);
    });
  ...
  methods._fields = function() {
    var
      self   = $(this),
      fields = self.is('form') ? $(this).find(':input[data-validaty]') : self;
  ...
  methods._process = function(fields, evt) {
    ...
    var valid = !this.inputs.filter('.invalid').length;

    $(this).data('valid', valid);

    if (valid && this.opt.onValid) {
      this.opt.onValid.call(this, this.inputs, evt);
    }
  };
  ...
  methods.validate = function(fields) {
    return this.each(function() {
      methods._process.call(this, [].concat.apply([], methods._distinct.call(this, fields)));
    });
  };
